...
duration: 1h
notes:
  - The `jobs.md` file complement the course.
todos:
  - Still a lot of work to remove that AI crap left by d.saison
---
...
It aims to ensure the **confidentiality**, **integrity** and **availability** of information and digital resources. This includes technical measures (such as firewalls and antivirus softwares), organizational measures (such as security policies) and physical measures (such as locks and surveillance cameras)
...
- **Traceability**  
  Ability to trace actions and events to detect and analyze security incidents.
...
## Security applied to Web Development
